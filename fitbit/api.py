...
class Fitbit(object):
    ...
    def time_series(self, resource, user_id=None, base_date='today',
        ...
        https://dev.fitbit.com/build/reference/web-api/activity-timeseries/
    ...
    def get_sleep_log_list(self, date, user_id=None, limit=100):
        ...
        https://dev.fitbit.com/build/reference/web-api/sleep/get-sleep-log-by-date/
        date should be a datetime.date object.
        Credit: https://github.com/murgo/python-fitbit/commit/a6cc47bcfa9702886e7c7e88c11c5ffdee398cdb
        """
